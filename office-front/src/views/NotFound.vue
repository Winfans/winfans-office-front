<template>
    <div id="da-wrapper" class="fluid">
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                <div id="da-error-wrapper">
                    ...
                    <p>大家可以到二狗子没有叼过的地方看看！ <a href="http://www.wffanshao.top/office">点击进入首页</a></p>
                </div>
            </div>
        </div>
        <!-- Footer -->
        <div id="da-footer">
            <div class="da-container clearfix">
                <a href="http://www.wffanshao.top/office">二狗办公</a>
            </div>
        </div>
    </div>
...
<style scoped>
    ...
    body {
        background-image: url("../assets/img/notfound/blueprint.png")
    }

    div#da-header #da-header-top {
        background-image: url("../assets/img/notfound/carbon.png")
    }
    ...
    div#da-header #da-header-top #da-header-toolbar #da-user-profile {
        ...
        padding: 0 12px;
        cursor: pointer;
        /*background: url("../assets/img/notfound/user-drop-arrow.png") no-repeat right center;*/
        padding-right: 24px
    }
    ...
    div#da-header #da-header-top #da-header-toolbar #da-header-button-container ul li.da-header-button {
        ...
        margin-left: 4px;
        position: relative;
        /*background: url("../assets/img/notfound/toolbar-button.png") no-repeat center top*/
    }
    ...
    div#da-header #da-header-top #da-header-toolbar #da-header-button-container ul li.notif.da-header-button > a {
        /*background-image: url("../assets/img/notfound/icons/white/16/alert_2.png")*/
    }

    div#da-header #da-header-top #da-header-toolbar #da-header-button-container ul li.message.da-header-button > a {
        /*background-image: url("../assets/img/notfound/icons/white/16/message_small.png")*/
    }

    div#da-header #da-header-top #da-header-toolbar #da-header-button-container ul li.logout.da-header-button > a {
        /*background-image: url("../assets/img/notfound/icons/white/16/off_small.png")*/
    }
    ...
    div#da-header #da-header-top #da-header-toolbar .message ul.da-header-dropdown ul.da-dropdown-sub li > a, div#da-header #da-header-top #da-header-toolbar .message ul.da-header-dropdown ul.da-dropdown-sub li > span {
        /*background: url("../assets/img/notfound/icons/color/email.png") no-repeat 12px center;*/
        padding-left: 40px
    }
    ...
    div#da-header #da-header-top #da-header-toolbar .message ul.da-header-dropdown ul.da-dropdown-sub li.read > a, div#da-header #da-header-top #da-header-toolbar .message ul.da-header-dropdown ul.da-dropdown-sub li.read > span {
        /*background-image: url("../assets/img/notfound/icons/color/email_open.png")*/
    }
    ...
    div#da-header #da-header-bottom {
        /*background: url("../assets/img/notfound/header-bottom.png") repeat-x left top*/
    }
    ...
    div#da-header #da-header-bottom #da-search input[type="text"] {
        width: 100%;
        /*background: #f0f0f0 url("../assets/img/notfound/search-icon.png") no-repeat right center;*/
    ...
    div#da-header #da-header-bottom #da-breadcrumb ul li.active {
        ...
        padding-top: 10px;
        padding-bottom: 22px;
        /*background: url("../assets/img/notfound/breadcrumb-arrow.png") no-repeat center bottom*/
    }
    ...
    div#da-wrapper #da-sidebar-separator, div#da-wrapper.fluid #da-sidebar-separator {
        ...
        top: 0;
        bottom: 0;
        /*background: url("../assets/img/notfound/container-separator.png") repeat-y center top*/
    }
    ...
    div#da-content #da-main-nav ul li a, div#da-content #da-main-nav ul li span {
        ...
        outline: 0;
        position: relative;
        /*background: url("../assets/img/notfound/menu-bulb-off.png") right center no-repeat*/
    }

    div#da-content #da-main-nav ul li.active a, div#da-content #da-main-nav ul li.active span {
        /*background-image: url("../assets/img/notfound/menu-bulb-on.png")*/
    }
    ...
    div#da-content #da-main-nav ul li ul {
        border: 0;
        /*background: #e9e9e9 url("../assets/img/notfound/submenu-shadow.png") repeat-x left top;*/
    ...
    div#da-content #da-main-nav ul li ul li:hover {
        /*background: url("../assets/img/notfound/menu-hover.png")*/
    }
    ...
    @media only screen and (max-width: 480px) {
        ...
        div#da-content #da-sidebar {
            ...
            cursor: pointer;
            float: none;
            /*background: url("../assets/img/notfound/icons/black/16/list.png") center 14px no-repeat, url("../assets/img/notfound/header-bottom.png") repeat-x left top*/
        }
    ...
    #da-customizer #da-customizer-pulldown {
        ...
        cursor: pointer;
        margin-top: -1px;
        /*background: url("../assets/img/notfound/icons/black/32/cog_5.png") no-repeat center center #fff;*/
        border-color: #999;
        border-color: rgba(0, 0, 0, .2);
        border-style: solid;
        border-width: 1px;
    ...
    div#da-error-wrapper #da-error-code {
        ...
        font-size: 32px;
        text-align: center;
        background: url("../assets/img/notfound/error-hanger.png") no-repeat center center;
    ...
    div#da-error-wrapper #da-error-pin {
        ...
        z-index: 10;
        position: relative;
        background: url("../assets/img/notfound/error-pin.png") no-repeat center center
    }
    ...
    .customfile-button {
        ...
        cursor: pointer;
        z-index: 9999;
        /*background: #f3f3f3 url("../assets/img/notfound/button-gradient.png") repeat-x left bottom;*/
        border: 1px solid #d1d1d1;
    ...
    .da-message.error {
        ...
        /*background-image: url("../assets/img/notfound/message-error.png");*/
        border-color: #eb979b;
        color: #9b4449
    }
    ...
    .da-message.success {
        ...
        /*background-image: url("../assets/img/notfound/message-success.png");*/
        border-color: #b5d56d;
        color: #62a426
    }
    ...
    .da-message.warning {
        ...
        /*background-image: url("../assets/img/notfound/message-warning.png");*/
        border-color: #ddca76;
        color: #a98b15
    }
    ...
    .da-message.info {
        ...
        /*background-image: url("../assets/img/notfound/message-info.png");*/
        border-color: #a6d3e8;
        color: #11689e
    }
    ...
    * html .da-button-row, * html .da-form-row, * html .da-form, * html .da-form-item, * html .da-form ul.da-form-list {
    ...
    .da-gallery ul li span.da-gallery-hover ul li.da-gallery-update a {
        /*background-image: url("../assets/img/notfound/icons/white/16/pencil.png");*/
        top: 50px;
    }

    .da-gallery ul li span.da-gallery-hover ul li.da-gallery-delete a {
        /*background-image: url("../assets/img/notfound/icons/white/16/cross_small.png");*/
        top: 150px
    }
    ...
    * html div.da-panel, * html div.da-panel .da-panel-content {
    ...
    div.da-panel .da-panel-header {
        ...
        /*background-image: url("../assets/img/notfound/panel-header.png");*/
        padding: 0 16px;
    ...
    div.da-panel .da-panel-header .da-panel-toggler {
        /*background: url("../assets/img/notfound/icons/black/16/bended_arrow_up.png") no-repeat center center;*/
    ...
    div.da-panel.collapsed .da-panel-header .da-panel-toggler {
        /*background-image: url("../assets/img/notfound/icons/black/16/bended_arrow_down.png")*/
    }
    ...
    div.da-panel .da-panel-content, div.da-panel-widget {
        ...
        /*background-image: url("../assets/img/notfound/panel-content.png");*/
    ...
    div.da-panel.scrollable .da-panel-content .scrollbar .track {
        height: 16px;
        width: 10px;
        /*background: url("../assets/img/notfound/scrollbar-track-bg.png") repeat-x;*/
        position: relative
    }
    ...
    div.da-panel.scrollable .da-panel-content .scrollbar .thumb {
        ...
        top: 0;
        position: absolute;
        /*background: #f0f0f0 url("../assets/img/notfound/scrollbar-grip.png") center center no-repeat*/
    }
    ...
    * html div.da-panel-toolbar ul {
    ...
    div.da-panel-toolbar ul, div.da-panel-toolbar ul.top {
        ...
        border-top: 0;
        /*background: url("../assets/img/notfound/toolbar-bg.png") repeat-x left bottom*/
    }
    ...
    .fc .fc-button-content {
        /*background: transparent url("../assets/img/notfound/button-gradient.png") repeat-x left bottom;*/
        -webkit-border-radius: 2px;
        -o-border-radius: 2px;
        -moz-border-radius: 2px;
        border-radius: 2px;
    ...
    .fc .fc-widget-header {
        /*background: url("../assets/img/notfound/default-header.png") repeat-x left bottom;*/
    ...
    .da-circular-stat {
        ...
        /*background: url("../assets/img/notfound/circular-stat-back.png") no-repeat center center;*/
    ...
    .da-circular-stat .da-circular-front {
        z-index: 100;
        /*background: url("../assets/img/notfound/circular-stat-front.png") no-repeat center center;*/
        background-size: 100% 100%
    }
    ...
    ul.da-summary-stat li .da-summary-text span.value.up {
        /*background: url("../assets/img/notfound/up.png") no-repeat right center;*/
        padding-right: 24px
    }

    ul.da-summary-stat li .da-summary-text span.value.down {
        /*background: url("../assets/img/notfound/down.png") no-repeat right center;*/
        padding-right: 24px
    }
    ...
    table.da-table thead tr {
        /*background: #eee url("../assets/img/notfound/default-header.png") repeat-x left top*/
    }
    ...
    .dataTables_wrapper .dataTables_paginate.paging_two_button .paginate_disabled_next, .dataTables_wrapper .dataTables_paginate.paging_two_button .paginate_enabled_next {
        /*background-image: url("../assets/img/notfound/dt-arrow-right.png")*/
    }
    ...
    .dataTables_wrapper .dataTables_paginate.paging_two_button .paginate_disabled_previous, .dataTables_wrapper .dataTables_paginate.paging_two_button .paginate_enabled_previous {
        /*background-image: url("../assets/img/notfound/dt-arrow-left.png")*/
    }
    ...
    .dataTables_wrapper table thead th.sorting {
        /*background-image: url("../assets/img/notfound/sort.png")*/
    }

    .dataTables_wrapper table thead th.sorting_asc {
        /*background-image: url("../assets/img/notfound/sort_asc.png")*/
    }

    .dataTables_wrapper table thead th.sorting_desc {
        /*background-image: url("../assets/img/notfound/sort_desc.png")*/
    }
    ...
    * html .da-wizard-nav ul {
    ...
    .da-wizard-nav ul li {
        ...
        position: relative;
        float: left;
        /*background: url("../assets/img/notfound/wizard-nav.png") no-repeat right center;*/
        box-sizing: border-box;
        -moz-box-sizing: border-box;
        -ms-box-sizing: border-box;
        -webkit-box-sizing: border-box;
    ...
    .da-wizard-nav ul li.active span, .da-wizard-nav ul li.active a {
        text-indent: -9999px;
        /*background: url("../assets/img/notfound/icons/color/asterisk_orange.png") no-repeat center center*/
    }

    .da-wizard-nav ul li.done span, .da-wizard-nav ul li.done a {
        text-indent: -9999px;
        /*background: url("../assets/img/notfound/icons/color/accept.png") no-repeat center center*/
    }
